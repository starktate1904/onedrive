...
def branch_list(request):
    ...
    try:
        ...
        return render(request, 'branches/branches.html', {'branches': branches,'active_nav_item':active_nav_item})
    except Exception as e:
        messages.error(request, 'Error fetching branches: {}'.format(e))
        return redirect('branches:branch_list',{'active_nav_item':active_nav_item})
...
def branch_create(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'branches/branches.html')
    return render(request, 'branches/branches.html',{'active_nav_item':active_nav_item})
...
def branch_employee_update(request, employee_id):
    ...
    if request.method == 'POST':
        ...
        branches = Branch.objects.all()
        return render(request, 'branches/branch_employees.html', {'employee': employee, 'branches': branches,'active_nav_item':active_nav_item})
...
def branch_employee_delete(request, employee_id):
    ...
    return redirect('branches:view_branch_employees',{'active_nav_item':active_nav_item})
